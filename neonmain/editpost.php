        ...
        <div class="row">   
            ...
            <div class="col-full s-content__main" >
                ...
                <h3 style="color:black; text-shadow: -1px 1px 0 #E01480,
                          1px 1px 0 #00ffff,
                         1px -1px 0 #00ffff,
                        -1px -1px 0 #00ffff; font-size:40px; text-align: center;">Edit Post</h3>
                ...
                <form name="create" id="create" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <fieldset>
                        ...
                        <div class="form-field">
                            <textarea id="editor" name='content' class="full-width" placeholder="Content" value=""></textarea> <script>
                            ClassicEditor
                        ...
                        <div class="form-field">
                            <input name="image" type="text" id="image" class="full-width" placeholder="Paste Image Link"  value="">
                        </div>
                        ...
                        <button name= "submitbutton" type="submit" class="submit btn btn--primary full-width" style = "color:red">Remove Post</button>
                ...
                <h3 style="color:black; text-shadow: -1px 1px 0 #E01480,
                          1px 1px 0 #00ffff,
                         1px -1px 0 #00ffff,
                        -1px -1px 0 #00ffff; font-size:40px; text-align: center;">Edit Comments</h3>
